    ...
    <div className="home">
      ...
      <div className="mainContainer">
        <div className="homeText">
          ...
          <p>Plantator est un site web vous permettant d'identifier une plante que vous rencontrez lors de vos balades en forêt, montagne ou simplement dans votre jardin.</p>
          <br></br>
