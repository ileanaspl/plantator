const plantes = [
	{
		...
		achillee: {
			id: 5,
			nom: [{ vernaculaire: 'Achillée millefeuille' }, { scientifique: 'Achillea millefolium' }],
		...
		aunee: {
			id: 6,
			nom: [{ vernaculaire: 'Grande aunée' }, { scientifique: 'Inula helenium' }],
		...
		epilobe: {
			id: 7,
			nom: [{ vernaculaire: 'Epilobe à petite fleur' }, { scientifique: 'Epilobium parviflorum' }],
		...
		digitale: {
			id: 9,
			nom: [{ vernaculaire: 'Digitale pourpre' }, { scientifique: 'Digitalis purpurea' }],
		...
		bourrache: {
			id: 10,
			nom: [{ vernaculaire: 'Bourrache officinale' }, { scientifique: 'Borago officinalis' }],
